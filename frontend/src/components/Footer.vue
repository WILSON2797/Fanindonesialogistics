  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          <h4>
            <i class="bi bi-truck footer-brand-icon"></i>
            {{ footer.brand_name }}
          </h4>
  ...
  data() {
    return {
      footer: {
        ...
        brand_desc: 'PT. Fan Indonesia Sejahtera — Your trusted logistics partner for your business. Connecting the archipelago with a modern fleet and professional services.',
        ...
        services_list: ['Land Transportation', 'Warehousing', 'Distribution', 'Supply Chain'],
