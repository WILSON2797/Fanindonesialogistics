  ...
  <div>
    ...
    <section class="page-banner" v-if="!hideBanner">
      <div class="container">
        ...
        <p data-aos="fade-up" data-aos-delay="100">Documentation of our activities and facilities</p>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="section-header" data-aos="fade-up">
          ...
          <h2 class="section-title">Our <span>Documentation</span></h2>
          <p class="section-subtitle">View our various activities, fleet, and facilities through our photo gallery</p>
        </div>
        ...
        <div class="gallery-filters" data-aos="fade-up" data-aos-delay="100">
          ...
          >
            <i :class="getCategoryIcon(cat)"></i> {{ translateCategory(cat) }}
          </button>
        </div>
          ...
          >
            <div class="gallery-img-wrap">
              <img
                ...
                :data-src="getImgUrl(item.image_path)"
                :alt="item.title"
              ...
              <div class="gallery-overlay">
                <div class="gallery-overlay-content">
                  ...
                  <h4>{{ item.title }}</h4>
                  <span class="gallery-cat-tag">{{ translateCategory(item.category) }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="empty-customers" v-if="!loading && filteredItems.length === 0">
          ...
          <h3>No photos in the gallery yet</h3>
      ...
      <div class="lightbox-overlay" v-if="lightbox.show" @click.self="closeLightbox">
        ...
        <div class="lightbox-content">
          <img
            ...
            :src="getImgUrl(currentLightboxItem.image_path)"
            :alt="currentLightboxItem.title"
            class="lightbox-img"
          >
          <div class="lightbox-placeholder" v-else>
            <i class="bi bi-image lightbox-placeholder-icon"></i>
          </div>
          <div class="lightbox-info" v-if="currentLightboxItem">
            ...
            <span class="gallery-cat-tag">{{ translateCategory(currentLightboxItem.category) }}</span>
          </div>
        </div>
...
export default {
  ...
  beforeUnmount() {
    ...
    // Ensure scroll is restored if unmounting while lightbox is open
  ...
  methods: {
    ...
    translateCategory(cat) {
      ...
      const translated = translations[cat.toLowerCase()] || cat;
